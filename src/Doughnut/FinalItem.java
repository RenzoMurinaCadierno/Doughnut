...
public final class FinalItem extends Item {
    ...
    public FinalItem(String letter, String condition, String question, 
                     String answer, String answerGiven, int status) {
        super(letter, condition, question, answer);
    ...
    public String toString() {
        return super.toString() + " - " + answerGiven 
                + " - " + status + ']';
    }
}
